...
import { App, Card, Typography, Space, Table, Button, Tag, message, Modal, List, Empty, Spin, Form, Input, Select, InputNumber, notification, Switch } from 'antd';
                  ...
                  <List.Item.Meta
                    ...
                    description={
                      <Space orientation="vertical" size="small">
                        ...
                        {log.error && (
                          <div style={{ color: token?.colorError }}>错误信息：{log.error}</div>
                        )}
                      </Space>
                    }
                  />
